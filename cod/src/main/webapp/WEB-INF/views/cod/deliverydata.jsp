			...
			<div class="main-container-inner">
				...
				<div class="main-content">
					...
					<div class="page-content">
                        ...
                        <form action="/deliverydata" method="get">
						...
						<div class="col-xs-12">
								...
								<div class="row" style="width: 100%;overflow-x: scroll;">
									...
									<table id="sample-table-1" class="table table-striped table-bordered table-hover" style="text-align: center;">
										...
										<tbody>
										<c:forEach var="item" items="${chartPstatistics}">
										<tr>
												<td>${item.person}</td>
												<td>${item.team}</td>
												...
												<td>${item.profit_roi}%</td>
												<td>${item.promotion_cost}</td>
												<td>${item.real_promotion_cost}</td>
